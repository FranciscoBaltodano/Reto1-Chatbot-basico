export const patterns = [
  {
    pattern: /\b(pendejo|pendeja|puto|puta|estupido|estupida|tonto|tonta|maricon|bruto|bruta|mierda|cerote|culero|culera|verga)\b/i,
    responses: [
  ...
  {
    pattern: /.*\b(adios|adiós|hasta luego|nos vemos)\b.*/i,
    responses: [
  ...
  {
    pattern: /.*\b(como estas|cómo estás|cómo te va|qué tal)\b.*/i,
    responses: [
  ...
  {
    pattern: /.*\b(donde estas|de dondeeres|dónde estás|de dónde eres)\b.*/i,
    responses: [
